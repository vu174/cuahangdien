    ...
    <nav class="site-navigation">
        <ul class="navmenu navmenu-depth-1  ">
            <li class="navmenu-item navmenu-id-home">
                <a class="navmenu-link navmenu-link--active" href="{{route('index')}}">Trang chủ</a>
            </li>
            <li class="navmenu-item navmenu-item-parent navmenu-id-shop navmenu-meganav-item-parent"
                data-navmenu-trigger
                data-navmenu-meganav-trigger>
                <a class="navmenu-link navmenu-link-parent " href="{{route('products')}}">
                    Sản phẩm
            ...
            <li class="navmenu-item">
                <a class="navmenu-link" href="{{isset($pages[0]) ? route('pages',$pages[0]->slug) : '#'}}">Về chúng tôi</a>
            </li>
            <li class="navmenu-item">
...
<div class="site-mobile-nav" id="site-mobile-nav" data-mobile-nav>
    <div class="mobile-nav-panel" data-mobile-nav-panel>
        ...
        <div class="mobile-nav-content">
            <ul class="navmenu  navmenu-depth-1  ">
                <li class="navmenu-item navmenu-id-home">
                    <a class="navmenu-link" href="{{route('index')}}">Trang chủ</a>
                </li>
                <li class="navmenu-item navmenu-item-parent navmenu-id-shop navmenu-meganav-item-parent"
                    data-navmenu-trigger="" data-navmenu-meganav-trigger="">
                    <a class="navmenu-link navmenu-link-parent" href="{{route('products')}}">
                ...
                <li class="navmenu-item navmenu-id-theme-features">
                    <a class="navmenu-link" href="{{isset($pages[3]) ? route('pages',$pages[3]->slug) : '#'}}">Thanh toán & Vận chuyển</a>
                </li>
                <li class="navmenu-item navmenu-id-theme-features">
                    <a class="navmenu-link" href="{{isset($pages[2]) ? route('pages',$pages[2]->slug) : '#'}}">Hướng dẫn mua hàng</a>
                </li>
            </ul>
        </div>
    </div>
